...
void UPawnCharacterMovementComponent::TickComponent(float DeltaTime, enum ELevelTick TickType, FActorComponentTickFunction *ThisTickFunction)
{
...
void UPawnCharacterMovementComponent::setMoveSpeed(float moveSpd)
{
	moveSpeed = moveSpd;
}